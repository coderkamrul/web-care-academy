...
export default function CreateProjectPage() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const [teamResponse, categoriesResponse] = await Promise.all([
          axios.get('/api/users?role=team'),
          Promise.resolve({ data: [] }) // Categories endpoint might not exist yet
        ]);
      ...
      <div className="max-w-6xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex items-center justify-between mb-8">
          <div className="flex items-center space-x-4">
            ...
            <div>
              ...
              <p className="text-gray-600 mt-1">Build something amazing</p>
            </div>
          </div>
        ...
        {saveProgress > 0 && saveProgress < 100 && (
          <div className="mb-6">
            ...
            <p className="text-sm text-gray-600 mt-2">Saving project...</p>
          </div>
        )}
